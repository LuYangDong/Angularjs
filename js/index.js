...
(function($){
    ...
    var effects = ['ws_brick'];
    var duration = 1700, delay = 4500;
    var cSlide, bkpCont, wowInstance, timeout;
    var wowSlider = $("#wowslider-container").wowSlider({effect: effects || "blinds",prev:"",next:"",fallback:ws_blinds,
        duration:duration,delay:delay,width:960,height:350,fullScreen:true,autoPlay:true,autoPlayVideo:false,
        stopOnHover:false,loop:false,bullets:true,caption:true,captionEffect:"move",controls:true});
